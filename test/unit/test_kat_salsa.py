"""Salsa: fast, default-run known-answer test on the generated Python (unrolled)
...
def test_salsa_permutation_kat():
    _kat(SALSA_PERMUTATION(r=None))


def test_salsa_keypermutation_kat():
    _kat(SALSA_KEYPERMUTATION(r=None))
