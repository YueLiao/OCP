"""AES: fast, default-run known-answer test on the generated Python (unrolled)
...
def test_aes_permutation_kat():
    _kat(AES_PERMUTATION(r=None))


@pytest.mark.parametrize("v", [[128, 128], [128, 192], [128, 256]])
def test_aes_blockcipher_kat(v):
    _kat(AES_BLOCKCIPHER(r=None, version=v))
