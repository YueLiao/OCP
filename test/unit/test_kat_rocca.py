"""Rocca-AD: fast, default-run known-answer test on the generated Python (unrolled)
...
def test_rocca_permutation_kat(v):
    _kat(ROCCA_AD_PERMUTATION(r=5, represent_mode=v))
