"""ChaCha: fast, default-run known-answer test on the generated Python (unrolled)
...
def test_chacha_permutation_kat():
    _kat(CHACHA_PERMUTATION(r=None))


def test_chacha_keypermutation_kat():
    _kat(CHACHA_KEYPERMUTATION(r=None))
