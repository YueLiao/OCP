"""Simon (primitive class): fast, default-run known-answer test on the generated Python (unrolled)
...
def test_simon_permutation_kat(v):
    _kat(SIMON_PERMUTATION(r=None, version=v))


@pytest.mark.parametrize("v", [[32, 64], [48, 72], [48, 96], [64, 96], [64, 128], [96, 96], [96, 144], [128, 128], [128, 192], [128, 256]])
def test_simon_blockcipher_kat(v):
    _kat(SIMON_BLOCKCIPHER(r=None, version=v))
