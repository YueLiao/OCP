...
def _add_forro_test_vector(primitive, output):
    # Test vectors from https://github.com/murcoutinho/forro_cipher/blob/main/test/test_ref.c
    primitive.test_vectors.append([[FORRO_TEST_INPUT], output])
...
class Forro_permutation(Permutation):
    ...
    def gen_test_vectors(self):
        _add_forro_test_vector(self, FORRO_PERMUTATION_TEST_OUTPUT)
...
class Forro_keypermutation(Permutation):
    ...
    def gen_test_vectors(self):
        _add_forro_test_vector(self, FORRO_KEYPERMUTATION_TEST_OUTPUT)
