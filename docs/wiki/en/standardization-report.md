...
- Migrated rotation and shift implementation/model behavior into stable operator unit tests.
- Migrated CopyOperator and NoneOperator behavior into stable operator unit tests.
...
- Consolidated repeated SHACAL2 composite-operator header, implementation, and model generation helpers.
- Fixed SHACAL2 composite model generation to call child operator model interfaces without unsupported arguments.
- Consolidated AES round layer traversal and made Matrix branch-number routing explicit.
...
Latest default pytest status: `217 passed, 106 skipped, 1 warning`.
